...
def check_complete_data(arr : list) :
    ...
    #if arr[0] == "D-GENE" and len(arr[5]) == 7 : tag = True
    #elif arr[0] == "V-GENE" and len(arr[5]) == 9 : tag = True
    #elif arr[0] == "J-GENE" and len(arr[5]) == 4 : tag = True

    if arr[0] == "D-GENE" and seg_length > 50 : tag = True
    elif arr[0] == "V-GENE" and seg_length > 100 : tag = True
    elif arr[0] == "J-GENE" and seg_length > 50 : tag = True
...
def read_FT(buf: str) :
    ...
    key2s = ["L-PART1", "L-PART2",
             ...
             "1st-CYS", "CONSERVED-TRP", "2nd-CYS","CDR3-IMGT",
    ...
    while i < L :
        if 'FT' in lines[i] :
            ...
            if out and rg and key in key2s :
                last_rg = out[-1][1]
